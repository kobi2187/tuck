...
`relight_moved` — the three arrays per lighting update that #82 is about.
`matching_engine` at 2 000 orders loses 16.6 KB in 9 blocks. Nim is clean
outright; D loses nothing of Tuck's.
