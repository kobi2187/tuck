...
fn main() -> int:
  return 0
"""
  t.okCheck "a contract member is callable through an interface value"
...
fn main() -> int:
  return 0
"""
  t.badCheck "the contract's return type is enforced", "int|str|noise"
...
fn main() -> int:
  return 0
"""
  t.badCheck "a member outside the contract is not reachable", "fetch|Animal"
...
"""
  t.okCheck "two objects reach one interface call site"
