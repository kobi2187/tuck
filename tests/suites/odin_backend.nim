...
"""
  ...
  #                        exercised twice.
  #   47-resource-registry 17  §7.4: three registry tables emitted from the
  #                        declaration, and a `defer` that zeroes its local
  #                        AFTER the return value is taken — 16+1, not 0. Run
  #                        rather than compiled because that ordering is the
  #                        whole claim, and only running shows it.
